...
INSERT into sottoCategoria(idSottocat,nomeSott)
	...
	values	('pac001','Sviluppo','svi001',49.90,'C è un linguaggio utile per quasi tutti i programmatori di computer. Alla fine di questo corso, capirai i fondamenti del linguaggio di programmazione C e ti renderai più commerciabile per le posizioni di programmazione entry level','Programmazione C per principianti','img/pacchetti/C1.jpg'),
			('pac002','Sviluppo','svi001',65.00,'C ++ può essere difficile da imparare, ma farlo ha enormi profitti. Se sei interessato ad imparare come usare C ++ per lo sviluppo del gioco, o una più ampia introduzione all\'argomento', 'Iniziare la programmazione in C ++ - Da principiante ad oltre','img/pacchetti/C++.jpg'),
			...
			('pac014','Informatica','inf002',119.90,'Dopo questo corso, sarete in grado di scoprire le vulnerabilità  della sicurezza su un\'intera rete, utilizzando tecniche di hacking della rete e scansione delle vulnerabilità  .','Il corso completo sulla sicurezza informatica','img/pacchetti/sicurezza.jpg'),
			...
			('pac016','Produttivita','pro001',40.00,'Questo corso di formazione completo di Microsoft Word ti insegnerà  come progettare e personalizzare i documenti professionali.','Microsoft Word completa','img/pacchetti/word.png'),
			...
			('pac018','Produttivita','pro001',65.00,'Al termine di questo corso avrai padroneggiato gli strumenti di Excel più diffusi e ne uscirai con fiducia per completare qualsiasi attività di Excel con efficienza e grazia.','Microsoft Excel - Excel da principiante ad avanzato','img/pacchetti/excel.jpg'),
			('pac019','Produttivita','pro001',100.00,'Questo corso è progettato per farti sentire comodo e sicuro utilizzando Access. è progettato per iniziare con le competenze necessarie per organizzare i dati nelle tabelle, estrarre i dati utilizzando le query e creare report puliti e professionali per impressionare il tuo capo.','Completa la padronanza di Microsoft Access','img/pacchetti/access.png'),
			('pac020','Produttivita','pro002',55.00,'Un corso facile da seguire progettato per insegnarti i principi fondamentali del lavoro con Oracle Database Technology','Apprendimento di Oracle 12c: un video di formazione Oracle','img/pacchetti/oracle.png'),
			('pac021','Produttivita','pro002',180.00,'Impara a diventare un amministratore di database Oracle (DBA) in 6 settimane e ottenere un lavoro ben pagato come un DBA Junior.','Oracle DBA 11g / 12c - Amministrazione database per DBA junior','img/pacchetti/dba.png'),
			...
			('pac026','Design','des002','200.00','Una guida completa che ti accompagna in ogni fase della costruzione di un gioco SHMUP professionale e raffinato utilizzando UE4.','Unreal Engine 4 - Impara a creare un prototipo di gioco in UE4','img/pacchetti/unreal-.png'),
			...
			('pac028','Design','des004',194.99,'Usa Blender per creare bellissimi modelli 3D per videogiochi, stampa 3D, design di case, ecc. Nessuna conoscenza richiesta.','Completa Blender Creator: impara la modellazione 3D','img/pacchetti/blender.jpg'),
			('pac029','Design','des004',140.00,'Guida AZ all\'apprendimento di animazioni 3D e modellazione con Blender per impostare l\'utente sulla creazione di fantastiche opere d\'arte 3D','Scopri l\'animazione 3D: la guida definitiva di Blender','img/pacchetti/blender1.png'),
			...
			('pac034','Musica','mus003',180.00,'Unisciti alla produzione musicale di successo + Gli studenti di Logic Pro X nella creazione, registrazione, mixaggio di musica e mastering in Logic Pro X','Produzione musicale in Logic Pro X - Il corso completo!','img/pacchetti/logicprox.jpg'),
			('pac035','Musica','mus003',50.00,'Master Avid Pro Tools 11. Scopri i segreti di produzione audio utilizzati dai professionisti. Un tutorial di Pro Tools facile da seguire.','Master Pro Tools 11 - Un corso Pro Tools definitivo','img/pacchetti/protools.jpg'),
			...
			('pac037','Fotografia','fot001',140.00,'In questo corso completo gli studenti impareranno come modificare i loro video utilizzando Final Cut Pro X da principiante a intermedio','Il corso Final Cut Pro X completo per principianti fino a intermedio','img/pacchetti/finalcutprox.jpg'),
			('pac038','Fotografia','fot001',170.00,'Se stai cercando un\'applicazione di editing video che ti consenta di modificare i video come preferisci, Adobe Premiere Pro è la migliore risposta. Premiere Pro è utilizzato  per ogni tipo di produzione da video aziendali e di marketing, video musicali a documentari, lungometraggi.','Adobe Premiere Pro CS6: il corso di editing video completo','img/pacchetti/adobepremiere.jpg'),
			...
			('pac040','Fotografia','fot002',99.99,'Scatti meravigliose foto notturne che impressionano la tua famiglia e i tuoi amici con questo corso completo di fotografia notturna!','Fotografia notturna: puoi scattare foto mozzafiato di notte','img/pacchetti/fotografare-notte.jpg' ),
			('pac041','Fotografia','fot003',49.99,'Con la fotografia di base , puoi imparare rapidamente a scattare meravigliose foto di cibo anche se non hai mai preso una macchina fotografica e non hai mai disegnato un piatto di cibo!','Fotografia di base dell\'alimento','img/pacchetti/fotografarecibo.jpg'),
			('pac042','Fotografia','fot003',189.99,'Impara esattamente come diventare un fotografo di matrimoni, avviare un\'attività  fotografica per conto tuo e scattare foto di nozze migliori.','Fotografia di matrimonio: guida completa alla fotografia di matrimonio','img/pacchetti/fotografare-matrimonio.jpg'),
			...
			('pac044','Insegnamento','ins001',79.99,'Più di 60 domande risolte per aiutarvi ad entrare nel flusso di problemi statistici di cracking (Binomiale, Distribuzione Normale ecc.)','Statistiche: variabili casuali e distribuzioni di probabilità','img/pacchetti/matematica.jpg'),
			('pac045','Insegnamento','ins001',98.99,'Master Discrete Math, la spina dorsale di Matematica e Informatica','Matematica discreta','img/pacchetti/discreta.jpg'),
			('pac046','Insegnamento','ins002',199.99,'Impara l\'inglese per principianti (A1-> A2 +) ','Corso di inglese completo: Impara la lingua inglese','img/pacchetti/inglese.jpg'),
			('pac047','Insegnamento','ins002',199.99,'Corso di spagnolo per principianti - Impara la lingua spagnola ','Corso di spagnolo completo: Impara la lingua spagnola | principianti','img/pacchetti/corsospagnolo.jpg'),
			('pac048','Business','bus001', 164.99,'Scopri come utilizzare l\'analisi aziendale per consigliare la soluzione migliore e cambiare strategia per raggiungere gli obiettivi della tua organizzazione ' ,'Analisi Aziendale : condurre un\'analisi strategica','img/pacchetti/analisiaziendale.jpg'),
