...
/**
 * Servlet implementation class OrdiniAmministratore
 */
@WebServlet("/OrdiniAmministratore")
public class OrdiniAmministratore extends HttpServlet {
	private static final long serialVersionUID = 1L;
 
    public OrdiniAmministratore() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {	
			listaOrdine = ordineAcquistoDao.findAllClient();
